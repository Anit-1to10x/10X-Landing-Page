...
2. Create 10-second test script
3. Create full user testing script customized for product
4. Define success criteria based on user goals
5. Create analysis template
6. Add participant finding recommendations
